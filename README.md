...
# have docker copy/overlay the HardLinked folder's contents into my-app itself
COPY HardLinked /
```

**Q/A**

* How is this different than just copying `parent_dir/common-files` to `parent_dir/my-app/common_files` before Docker runs?
> There are two advantages:
> 1) `file-syncer` watches the source directory, mirroring any file creations/deletions that occur. (this can be turned off if desired)
